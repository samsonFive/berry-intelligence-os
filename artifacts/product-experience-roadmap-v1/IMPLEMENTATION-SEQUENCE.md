# Product Experience Roadmap V1 — Implementation Sequence

| Order | Slice | Entry condition | Exit gate |
|---:|---|---|---|
| 1 | Integrated foundation | Exact integration checkpoint and CI environment | 33/33, identity/content honesty, records, static, browser, full suite |
| 2 | Controlled source activation | Sol checkpoint and human sign-off | Bounded runs with durable outcomes and no synthetic records |
| 3 | Daily Reading Loop + Reader | Foundation stable and readable fixtures available | URL-backed feed, Reader keyboard/mobile/focus, date honesty |
| 4 | Trust feedback | Stable Reader/card identity and event conventions | Typed reversible events, provenance retention, no auto-trust |
| 5 | Visual convergence + personal state | Reader and feedback proven | Shared tokens, saved views/read state, responsive gates |
| 6 | Source optimization | Repeated comparable runs and review outcomes | Sample-aware telemetry with denominators and explicit gaps |
