...
| **Recommended resolution** | Keep Google News RSS as the production default. Optional Perplexity Search catch-net behind `DiscoveryProvider` after an explicit activation mission and tighter qualification. Live-test Exa/Firecrawl when keys exist. |
| **Status** | active |
