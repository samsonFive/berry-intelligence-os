"""Frozen Industry Pulse qualifier as of Retrieval Provider Bake-Off V1.

Used only to score BEFORE metrics on the qualification benchmark.
Product code calls `qualify.py`, not this module.
"""
